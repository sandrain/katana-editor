...
void editPage::addGRYButton(int row, int column, int rowSpan, int columnSpan,
                            QString hex1,
                            QString hex2,
                            QString hex3,
                            QString direction,
                            Qt::Alignment alignment)
   {
       customControlGRYButton *grybutton = new customControlGRYButton(this, hex1, hex2, hex3, direction);
if(this->groupBoxMode)
{
    this->groupBoxLayout->addWidget(grybutton, row, column, rowSpan, columnSpan, alignment);
}
else if(this->stackFieldMode)
{
    this->stackField->addWidget(grybutton, row, column, rowSpan, columnSpan, alignment);
}
else
{
    this->layout->addWidget(grybutton, row, column, rowSpan, columnSpan, alignment);
};
}

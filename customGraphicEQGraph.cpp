...
void customGraphicEQGraph::paintEvent ( QPaintEvent *pPaintEvent )
{
    ...
    QPixmap image = QPixmap(":/images/geq_graph.png");
    ...
    int b1 = h - (m_iBand_1*p) + q;
    int b2 = h - (m_iBand_2*p) + q;
    int b3 = h - (m_iBand_3*p) + q;
    int b4 = h - (m_iBand_4*p) + q;
    int b5 = h - (m_iBand_5*p) + q;
    int b6 = h - (m_iBand_6*p) + q;
    int b7 = h - (m_iBand_7*p) + q;
    int b8 = h - (m_iBand_8*p) + q;
    int b9 = h - (m_iBand_9*p) + q;
    int b10 = h - (m_iBand_10*p) + q;

    int lev = h/6 - ((m_iLevel*p));

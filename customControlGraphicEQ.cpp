                                     ...
                                     : QWidget(parent)
{
    ...
    if (background.contains("System")) {this->area = "System";} else {this->area = "Structure";};
    ...
    this->knob_1->setFixedHeight(190*ratio);
    this->knob_1->setFixedWidth(45*ratio);
    ...
    knob_1Layout->setSpacing(5*ratio);
    ...
    this->knob_2->setFixedHeight(190*ratio);
    this->knob_2->setFixedWidth(45*ratio);
    ...
    knob_2Layout->setSpacing(5*ratio);
    ...
    this->knob_3->setFixedHeight(190*ratio);
    this->knob_3->setFixedWidth(45*ratio);
    ...
    knob_3Layout->setSpacing(5*ratio);
    ...
    this->knob_4->setFixedHeight(190*ratio);
    this->knob_4->setFixedWidth(45*ratio);
    ...
    knob_4Layout->setSpacing(5*ratio);
    ...
    this->knob_5->setFixedHeight(190*ratio);
    this->knob_5->setFixedWidth(45*ratio);
    ...
    knob_5Layout->setSpacing(5*ratio);
    ...
    this->knob_6->setFixedHeight(190*ratio);
    this->knob_6->setFixedWidth(45*ratio);
    ...
    knob_6Layout->setSpacing(5*ratio);
    ...
    this->knob_7->setFixedHeight(190*ratio);
    this->knob_7->setFixedWidth(45*ratio);
    ...
    knob_7Layout->setSpacing(5*ratio);
    ...
    this->knob_8->setFixedHeight(190*ratio);
    this->knob_8->setFixedWidth(45*ratio);
    ...
    knob_8Layout->setSpacing(5*ratio);
    ...
    this->knob_9->setFixedHeight(190*ratio);
    this->knob_9->setFixedWidth(45*ratio);
    ...
    knob_9Layout->setSpacing(5*ratio);
    ...
    this->knob_10->setFixedHeight(190*ratio);
    this->knob_10->setFixedWidth(45*ratio);
    ...
    knob_10Layout->setSpacing(5*ratio);
    ...
    this->knob_11->setFixedHeight(190*ratio);
    this->knob_11->setFixedWidth(45*ratio);
    ...
    knob_11Layout->setSpacing(5*ratio);
    ...
    this->frame->setMinimumSize(QSize(800*ratio, 400*ratio));
    ...
    graphLayout->setSpacing(25*ratio);
...
void customControlGraphicEQ::paintEvent(QPaintEvent *)
{
    ...
    /*QPixmap image(":images/geq_graph.png"); //":images/dragbar.png");

    QRectF target(0.0, 0.0, this->width(), this->height()*7/5);
...
{
    QString hex = QString::number(iBand_1, 16).toUpper();
...
{
    QString hex = QString::number(iBand_2, 16).toUpper();
    if (hex.size() < 2) hex.prepend("0");
    SysxIO *sysxIO = SysxIO::Instance();
...
{
    QString hex = QString::number(iBand_3, 16).toUpper();
    if (hex.size() < 2) hex.prepend("0");
    SysxIO *sysxIO = SysxIO::Instance();
...
{
    QString hex = QString::number(iBand_4, 16).toUpper();
    if (hex.size() < 2) hex.prepend("0");
    SysxIO *sysxIO = SysxIO::Instance();
...
{
    QString hex = QString::number(iBand_5, 16).toUpper();
    if (hex.size() < 2) hex.prepend("0");
    SysxIO *sysxIO = SysxIO::Instance();
...
{
    QString hex = QString::number(iBand_6, 16).toUpper();
    if (hex.size() < 2) hex.prepend("0");
    SysxIO *sysxIO = SysxIO::Instance();
...
{
    QString hex = QString::number(iBand_7, 16).toUpper();
    if (hex.size() < 2) hex.prepend("0");
    SysxIO *sysxIO = SysxIO::Instance();
...
{
    QString hex = QString::number(iBand_8, 16).toUpper();
    if (hex.size() < 2) hex.prepend("0");
    SysxIO *sysxIO = SysxIO::Instance();
...
{
    QString hex = QString::number(iBand_9, 16).toUpper();
    if (hex.size() < 2) hex.prepend("0");
    SysxIO *sysxIO = SysxIO::Instance();
...
{
    QString hex = QString::number(iBand_10, 16).toUpper();
    if (hex.size() < 2) hex.prepend("0");
    SysxIO *sysxIO = SysxIO::Instance();

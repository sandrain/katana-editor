...
customAssign::customAssign(bool active, QPoint ledPos, QWidget *parent,
                                 QString imagePath)
                                     : QWidget(parent)
{
    ...
    this->active = active;
    this->imagePath = ":/images/assignBar.png";
...
void customAssign::paintEvent(QPaintEvent *)
{
    Preferences *preferences = Preferences::Instance();
    bool ok;
    const double ratio = preferences->getPreferences("Window", "Scale", "ratio").toDouble(&ok);
...
void customAssign::setOffset(signed int imageNr)
{
    this->yOffset = imageNr*ledSize.height();
    this->update();
}

void customAssign::setValue(bool value)
{
    this->active = value;
    if(active)
    {
...
void customAssign::changeValue(bool value)
{
        setValue(value);
}

void customAssign::fadeIn()
{

...

{
    ...
    QFont Lfont( "Arial", 8*fratio, QFont::Normal);
    ...
    this->catagoryDisplay->setFont(Lfont);
    if (this->length == "80")
    {this->catagoryDisplay->setFixedWidth(1100*ratio);}
    else if (this->length == "20")
    {this->catagoryDisplay->setFixedWidth(280*ratio);}
    else

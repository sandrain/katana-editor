    ...
    : QWidget(parent)
{
    ...
    else
    {
        ...
        QFont Cfont( "Arial", 9*fratio, QFont::Normal);
        this->controlListComboBox->setFont(Cfont);
    };
    this->hex1 = hex1;
    this->hex2 = hex2;
    ...
    if(labeltxt=="GREEN"){this->controlListComboBox->setStyleSheet("color: black;"
                                                                   "background-color: green;"
                                                                   "selection-color: yellow;"
                                                                   "selection-background-color: blue;"); };
    if(labeltxt=="RED"){this->controlListComboBox->setStyleSheet("color: black;"
                                                                 "background-color: red;"
                                                                 "selection-color: yellow;"
                                                                 "selection-background-color: blue;");  };
    if(labeltxt=="YELLOW"){this->controlListComboBox->setStyleSheet("color: black;"

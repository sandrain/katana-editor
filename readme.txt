...
KATANAFxFloorBoard version 20110317: 17 March 2011
*****************************************************
PLEASE FEEL FREE TO DONATE, YOU MAY FREELY USE THIS SOFTWARE, 
 JUST KEEP IN MIND THE 7000 HOURS SPENT OVER 5 YEARS GETTING IT HERE,
  I WOULD LOVE A BEER!!!. :-)
 ...
 *Auditioning of Patches within Bulk Files, high-lighted file is sent to the KATANA for instant auditioning before loading. 
...
b.) In most cases the program should select GT 10 device and connect automaticaly, if not, then follow the next two steps.
...
- sound played through the GT100 will have the sound of that patch.
...
h.) To save the patch to the GT100, select a location with a 'single-click' on the Patch-Tree,
then press the "write/sync" button. 

****************** If there is a problem 'connecting' ensure the KATANA UNIT ID is set to "1" (factory default) 
...
the KATANAFxFloorBoard will also open GT100B *.gxb & *.mid files, and translate GT-8 patch files (*.syx single patch type).

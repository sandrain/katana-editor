...
void customMultiComboBox::makeList()
{
    ...
    display_10 = new customControlMidiTable(this, hex1, hex2 ,hex3, "KATANA Patch", comboList);
...
void customMultiComboBox::setComboBoxList()
{
    ...
    Midi item_2;
    Midi item_3;
    item_0 = midiTable->getMidiMap("System", "02", "01", "00", "00");
    item_1 = midiTable->getMidiMap("System", "02", "01", "00", "01");
    item_2 = midiTable->getMidiMap("System", "02", "01", "00", "02");
    item_3 = midiTable->getMidiMap("System", "02", "01", "00", "03");
    items = item_0;
